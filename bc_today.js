...
*/
// changes the date to the present date on the webpage.it will display the info that is supposed to be displayed for that day. the information will change depenending on time and date.it will display the date as a header. 
